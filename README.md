I build AI automation for document workflows: RAG systems, transcript and caption pipelines, and compliance document tooling. Python, based in Romania, available for freelance and contract work.
...
I benchmark before claiming, publish the caveats, and ship features disabled when the measurement says to.
